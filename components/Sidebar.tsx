...
const Sidebar=()=>{
  ...
  return(
    <div className="px-5 sm:px-24 md:px-12 lg:px-1  ">
      ...
      <a href="" download=""
       className="py-1 px-1 mt-2 flex flex-row justify-center items-center   w-full bg-gray-200 rounded-full flex justify-center lg:text-[0.7rem] bg-gray-300 dark:bg-dark-200">
